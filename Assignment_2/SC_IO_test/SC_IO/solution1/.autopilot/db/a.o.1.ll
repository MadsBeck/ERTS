; ModuleID = 'C:/ERTS_Repo/Assignment_2/SC_IO_test/SC_IO/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

%struct.iosc.12 = type { %"class._ap_sc_::sc_core::sc_in.3", %"class._ap_sc_::sc_core::sc_in.3", %"class._ap_sc_::sc_core::sc_in.0.9", %"class._ap_sc_::sc_core::sc_in.0.9", %"class._ap_sc_::sc_core::sc_out.11", %"class._ap_sc_::sc_core::sc_in.3", %"struct._ap_sc_::sc_dt::sc_uint.6" }
...
@ssdm_ins_iosc_0_0 = constant %struct.iosc.12 zeroinitializer, align 1 ; [#uses=0 type=%struct.iosc.12*]
...
; [#uses=1]
define void @"iosc::timeThread"(%struct.iosc.12* %this) noreturn nounwind noinline align 2 {
_ZN7_ap_sc_7sc_core4waitEi.exit:
  call void @llvm.dbg.value(metadata !{%struct.iosc.12* %this}, i64 0, metadata !4388), !dbg !4390 ; [debug line = 37:12] [debug variable = this]
  %this.addr = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 0, !dbg !4391 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 38:4]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr) nounwind, !dbg !4391 ; [debug line = 38:4]
  %this.addr.1 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 1, !dbg !4393 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 39:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.1) nounwind, !dbg !4393 ; [debug line = 39:3]
  %this.addr.2 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 2, !dbg !4394 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.0.9"*] [debug line = 40:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str5, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.2) nounwind, !dbg !4394 ; [debug line = 40:3]
  %this.addr.3 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 3, !dbg !4395 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.0.9"*] [debug line = 41:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str6, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.3) nounwind, !dbg !4395 ; [debug line = 41:3]
  %this.addr.4 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 4, !dbg !4396 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_out.11"*] [debug line = 42:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 1, i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8]* @.str7, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.4) nounwind, !dbg !4396 ; [debug line = 42:3]
  call void (...)* @_ssdm_op_SpecProcessDef(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([11 x i8]* @.str16, i32 0, i32 0)) nounwind, !dbg !4397 ; [debug line = 43:3]
  call void (...)* @_ssdm_InlineSelf(i32 2) nounwind, !dbg !4398 ; [debug line = 43:85]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !4399 ; [#uses=1 type=i32] [debug line = 43:106]
  call void (...)* @_ssdm_UnrollRegion(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([15 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !4400 ; [debug line = 43:143]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !4401 ; [debug line = 43:190]
  %_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !4402 ; [#uses=1 type=i32] [debug line = 43:240]
  call void @llvm.dbg.value(metadata !{i32 %_ssdm_reset_v}, i64 0, metadata !4403), !dbg !4402 ; [debug line = 43:240] [debug variable = _ssdm_reset_v]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr) nounwind, !dbg !4404 ; [debug line = 44:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.1) nounwind, !dbg !4405 ; [debug line = 45:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str5, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.2) nounwind, !dbg !4406 ; [debug line = 46:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str6, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.3) nounwind, !dbg !4407 ; [debug line = 47:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8]* @.str7, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.4) nounwind, !dbg !4408 ; [debug line = 48:1]
  %this.addr.5 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 5, !dbg !4409 ; [#uses=1 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str12, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.5) nounwind, !dbg !4409 ; [debug line = 49:1]
  %this.addr.6 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 6, !dbg !4410 ; [#uses=1 type=%"struct._ap_sc_::sc_dt::sc_uint.6"*] [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8]* @.str13, i32 0, i32 0), %"struct._ap_sc_::sc_dt::sc_uint.6"* %this.addr.6) nounwind, !dbg !4410 ; [debug line = 50:1]
  %0 = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %_ssdm_reset_v) nounwind, !dbg !4411 ; [#uses=0 type=i32] [debug line = 51:44]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str9, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !4412 ; [#uses=0 type=i32] [debug line = 51:82]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !4413 ; [debug line = 803:19@39:1]
  %P.assign = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 5, i32 0, i32 0, i32 0, !dbg !4417 ; [#uses=3 type=i1*] [debug line = 207:13@41:1]
  call void @llvm.dbg.value(metadata !{i1* %P.assign}, i64 0, metadata !4420), !dbg !4421 ; [debug line = 128:96@207:13@41:1] [debug variable = P]
  store volatile i1 false, i1* %P.assign, align 1, !dbg !4422 ; [debug line = 167:116@207:13@41:1]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2, !dbg !4424 ; [debug line = 41:17]

_ZN7_ap_sc_7sc_core4waitEi.exit2:                 ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, %_ZN7_ap_sc_7sc_core4waitEi.exit
  %count = phi i32 [ 0, %_ZN7_ap_sc_7sc_core4waitEi.exit ], [ %count.0.be, %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge ] ; [#uses=2 type=i32]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !4425 ; [debug line = 803:19@44:3]
  %tmp = icmp slt i32 %count, 100000000, !dbg !4428 ; [#uses=1 type=i1] [debug line = 45:3]
  br i1 %tmp, label %1, label %2, !dbg !4428      ; [debug line = 45:3]

; <label>:1                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  %count.1 = add nsw i32 %count, 1, !dbg !4429    ; [#uses=1 type=i32] [debug line = 47:4]
  call void @llvm.dbg.value(metadata !{i32 %count.1}, i64 0, metadata !4431), !dbg !4429 ; [debug line = 47:4] [debug variable = count]
  call void @llvm.dbg.value(metadata !{i1* %P.assign}, i64 0, metadata !4420), !dbg !4432 ; [debug line = 128:96@207:13@48:4] [debug variable = P]
  store volatile i1 false, i1* %P.assign, align 1, !dbg !4435 ; [debug line = 167:116@207:13@48:4]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, !dbg !4436 ; [debug line = 49:3]

; <label>:2                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  call void @llvm.dbg.value(metadata !{i1* %P.assign}, i64 0, metadata !4420), !dbg !4437 ; [debug line = 128:96@207:13@53:4] [debug variable = P]
  store volatile i1 true, i1* %P.assign, align 1, !dbg !4441 ; [debug line = 167:116@207:13@53:4]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge

_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge:        ; preds = %2, %1
  %count.0.be = phi i32 [ %count.1, %1 ], [ 0, %2 ] ; [#uses=1 type=i32]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2
}

; [#uses=0]
define weak void @"iosc::iosc"(%struct.iosc.12* %this, %"class.std::ios_base::Init.0"*) unnamed_addr nounwind align 2 {
  call void @llvm.dbg.value(metadata !{%struct.iosc.12* %this}, i64 0, metadata !4442), !dbg !4443 ; [debug line = 18:3] [debug variable = this]
  call void (...)* @_ssdm_op_SpecTopModule(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !4444 ; [debug line = 20:5]
  call void (...)* @_ssdm_InlineSelf(i32 2) nounwind, !dbg !4446 ; [debug line = 20:65]
  %"iosc::__ssdm_thread_M_iosThread.load" = load i1* @"iosc::__ssdm_thread_M_iosThread", align 1, !dbg !4447 ; [#uses=1 type=i1] [debug line = 21:5]
  br i1 %"iosc::__ssdm_thread_M_iosThread.load", label %2, label %3, !dbg !4447 ; [debug line = 21:5]

; <label>:2                                       ; preds = %1
  call void @"iosc::iosThread"(%struct.iosc.12* %this), !dbg !4448 ; [debug line = 21:36]
  unreachable

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecProcessDecl(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([10 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !4449 ; [debug line = 21:49]
  %this.addr = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 0, !dbg !4450 ; [#uses=4 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 22:5]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([10 x i8]* @.str8, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr, i32 1) nounwind, !dbg !4450 ; [debug line = 22:5]
  %this.addr.8 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 1, !dbg !4451 ; [#uses=3 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 23:5]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([10 x i8]* @.str8, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.8, i32 3) nounwind, !dbg !4451 ; [debug line = 23:5]
  %"iosc::__ssdm_thread_M_timeThread.load" = load i1* @"iosc::__ssdm_thread_M_timeThread", align 1, !dbg !4452 ; [#uses=1 type=i1] [debug line = 24:5]
  br i1 %"iosc::__ssdm_thread_M_timeThread.load", label %4, label %5, !dbg !4452 ; [debug line = 24:5]

; <label>:4                                       ; preds = %3
  call void @"iosc::timeThread"(%struct.iosc.12* %this), !dbg !4453 ; [debug line = 24:37]
  unreachable

; <label>:5                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecProcessDecl(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([11 x i8]* @.str16, i32 0, i32 0)) nounwind, !dbg !4454 ; [debug line = 24:51]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([11 x i8]* @.str16, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr, i32 1) nounwind, !dbg !4455 ; [debug line = 25:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr) nounwind, !dbg !4456 ; [debug line = 26:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.8) nounwind, !dbg !4457 ; [debug line = 27:5]
  %this.addr.9 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 2, !dbg !4458 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.0.9"*] [debug line = 28:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str5, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.9) nounwind, !dbg !4458 ; [debug line = 28:5]
  %this.addr.10 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 3, !dbg !4459 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.0.9"*] [debug line = 29:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str6, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.10) nounwind, !dbg !4459 ; [debug line = 29:5]
  %this.addr.11 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 4, !dbg !4460 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_out.11"*] [debug line = 30:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 1, i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8]* @.str7, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.11) nounwind, !dbg !4460 ; [debug line = 30:5]
  %this.addr.12 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 5, !dbg !4461 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 31:5]
  call void (...)* @_ssdm_op_SpecChannel(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str12, i32 0, i32 0), i32 1, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.12) nounwind, !dbg !4461 ; [debug line = 31:5]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr) nounwind, !dbg !4462 ; [debug line = 32:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.8) nounwind, !dbg !4463 ; [debug line = 33:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str5, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.9) nounwind, !dbg !4464 ; [debug line = 34:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str6, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.10) nounwind, !dbg !4465 ; [debug line = 35:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8]* @.str7, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.11) nounwind, !dbg !4466 ; [debug line = 36:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str12, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.12) nounwind, !dbg !4467 ; [debug line = 37:1]
  %this.addr.13 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 6, !dbg !4468 ; [#uses=1 type=%"struct._ap_sc_::sc_dt::sc_uint.6"*] [debug line = 38:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8]* @.str13, i32 0, i32 0), %"struct._ap_sc_::sc_dt::sc_uint.6"* %this.addr.13) nounwind, !dbg !4468 ; [debug line = 38:1]
  ret void, !dbg !4469                            ; [debug line = 29:1]
}

; [#uses=1]
define void @"iosc::iosThread"(%struct.iosc.12* %this) noreturn nounwind noinline align 2 {
_ZN7_ap_sc_7sc_core4waitEi.exit:
  call void @llvm.dbg.value(metadata !{%struct.iosc.12* %this}, i64 0, metadata !4470), !dbg !4471 ; [debug line = 3:12] [debug variable = this]
  %this.addr = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 0, !dbg !4472 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 4:4]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr) nounwind, !dbg !4472 ; [debug line = 4:4]
  %this.addr.14 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 1, !dbg !4474 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 5:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.14) nounwind, !dbg !4474 ; [debug line = 5:3]
  %this.addr.15 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 2, !dbg !4475 ; [#uses=3 type=%"class._ap_sc_::sc_core::sc_in.0.9"*] [debug line = 6:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str5, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.15) nounwind, !dbg !4475 ; [debug line = 6:3]
  %this.addr.16 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 3, !dbg !4476 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.0.9"*] [debug line = 7:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str6, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.16) nounwind, !dbg !4476 ; [debug line = 7:3]
  %this.addr.17 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 4, !dbg !4477 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_out.11"*] [debug line = 8:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 1, i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8]* @.str7, i32 0, i32 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.17) nounwind, !dbg !4477 ; [debug line = 8:3]
  call void (...)* @_ssdm_op_SpecProcessDef(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([10 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !4478 ; [debug line = 9:3]
  call void (...)* @_ssdm_InlineSelf(i32 2) nounwind, !dbg !4479 ; [debug line = 9:84]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !4480 ; [#uses=1 type=i32] [debug line = 9:105]
  call void (...)* @_ssdm_UnrollRegion(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([15 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !4481 ; [debug line = 9:142]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !4482 ; [debug line = 9:189]
  %_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !4483 ; [#uses=1 type=i32] [debug line = 9:239]
  call void @llvm.dbg.value(metadata !{i32 %_ssdm_reset_v}, i64 0, metadata !4484), !dbg !4483 ; [debug line = 9:239] [debug variable = _ssdm_reset_v]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr) nounwind, !dbg !4485 ; [debug line = 10:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.14) nounwind, !dbg !4486 ; [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str5, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.15) nounwind, !dbg !4487 ; [debug line = 12:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str6, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.16) nounwind, !dbg !4488 ; [debug line = 13:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8]* @.str7, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.17) nounwind, !dbg !4489 ; [debug line = 14:1]
  %this.addr.18 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 5, !dbg !4490 ; [#uses=1 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 15:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str12, i32 0, i32 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.18) nounwind, !dbg !4490 ; [debug line = 15:1]
  %this.addr.19 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 6, !dbg !4491 ; [#uses=1 type=%"struct._ap_sc_::sc_dt::sc_uint.6"*] [debug line = 16:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8]* @.str13, i32 0, i32 0), %"struct._ap_sc_::sc_dt::sc_uint.6"* %this.addr.19) nounwind, !dbg !4491 ; [debug line = 16:1]
  call void (...)* @_ssdm_op_SpecResource(%"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.15, i8* getelementptr inbounds ([1 x i8]* @.str10, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8]* @.str14, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str10, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str10, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str10, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str10, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str10, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8]* @.str15, i32 0, i32 0)) nounwind, !dbg !4492 ; [debug line = 5:1]
  %0 = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %_ssdm_reset_v) nounwind, !dbg !4493 ; [#uses=0 type=i32] [debug line = 5:92]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str9, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !4494 ; [#uses=0 type=i32] [debug line = 5:130]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !4495 ; [debug line = 803:19@8:1]
  %this.addr.20 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 3, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !4497 ; [#uses=2 type=i4*] [debug line = 374:13@60:21@180:66@351:73@14:7]
  %this.addr.21 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 2, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !4507 ; [#uses=2 type=i4*] [debug line = 374:13@60:21@180:66@351:73@18:7]
  %P.assign = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 5, i32 0, i32 0, i32 0, !dbg !4512 ; [#uses=1 type=i1*] [debug line = 180:66@20:8]
  %this.addr.23 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 4, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !4516 ; [#uses=3 type=i4*] [debug line = 365:13@56:100@207:13@427:73@22:5]
  %this.addr.24 = getelementptr inbounds %struct.iosc.12* %this, i32 0, i32 6, i32 0, i32 0, i32 0, !dbg !4526 ; [#uses=1 type=i4*] [debug line = 378:13@31:32]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2, !dbg !4530 ; [debug line = 9:26]

_ZN7_ap_sc_7sc_core4waitEi.exit2:                 ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, %_ZN7_ap_sc_7sc_core4waitEi.exit
  %count = phi i8 [ 0, %_ZN7_ap_sc_7sc_core4waitEi.exit ], [ %count.0.be, %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge ] ; [#uses=1 type=i8]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !4531 ; [debug line = 803:19@13:3]
  %val.V = load volatile i4* %this.addr.20, align 1, !dbg !4497 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@14:7]
  call void @llvm.dbg.value(metadata !{i4 %val.V}, i64 0, metadata !4533), !dbg !4497 ; [debug line = 374:13@60:21@180:66@351:73@14:7] [debug variable = val.V]
  %tmp = icmp eq i4 %val.V, -8, !dbg !4541        ; [#uses=1 type=i1] [debug line = 1979:9@3571:144@14:7]
  %v.assign = select i1 %tmp, i8 0, i8 %count, !dbg !4505 ; [#uses=4 type=i8] [debug line = 14:7]
  %val.V.1 = load volatile i4* %this.addr.21, align 1, !dbg !4507 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@18:7]
  call void @llvm.dbg.value(metadata !{i4 %val.V.1}, i64 0, metadata !4533), !dbg !4507 ; [debug line = 374:13@60:21@180:66@351:73@18:7] [debug variable = val.V]
  %tmp.2 = icmp eq i4 %val.V.1, 0, !dbg !4545     ; [#uses=1 type=i1] [debug line = 1979:9@3571:144@18:7]
  br i1 %tmp.2, label %1, label %4, !dbg !4511    ; [debug line = 18:7]

; <label>:1                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  call void @llvm.dbg.value(metadata !{i1* %P.assign}, i64 0, metadata !4547), !dbg !4548 ; [debug line = 166:90@180:66@20:8] [debug variable = P]
  %tmp.3 = load volatile i1* %P.assign, align 1, !dbg !4549 ; [#uses=1 type=i1] [debug line = 166:95@180:66@20:8]
  call void @llvm.dbg.value(metadata !{i1 %tmp.3}, i64 0, metadata !4551), !dbg !4512 ; [debug line = 180:66@20:8] [debug variable = tmp]
  br i1 %tmp.3, label %2, label %3, !dbg !4514    ; [debug line = 20:8]

; <label>:2                                       ; preds = %1
  %count.3 = add i8 %v.assign, 1, !dbg !4524      ; [#uses=2 type=i8] [debug line = 22:5]
  call void @llvm.dbg.value(metadata !{i8 %count.3}, i64 0, metadata !4552), !dbg !4524 ; [debug line = 22:5] [debug variable = count]
  call void @llvm.dbg.value(metadata !{i8 %count.3}, i64 0, metadata !4553), !dbg !4554 ; [debug line = 340:69@22:5] [debug variable = v]
  call void @llvm.dbg.value(metadata !{i8 %count.3}, i64 0, metadata !4555), !dbg !4556 ; [debug line = 340:69@340:92@22:5] [debug variable = v]
  call void @llvm.dbg.value(metadata !{i8 %count.3}, i64 0, metadata !4558), !dbg !4559 ; [debug line = 1453:78@340:90@340:92@22:5] [debug variable = op]
  %v.V.1 = trunc i8 %count.3 to i4, !dbg !4561    ; [#uses=1 type=i4] [debug line = 1453:84@340:90@340:92@22:5]
  call void @llvm.dbg.value(metadata !{i4 %v.V.1}, i64 0, metadata !4563), !dbg !4565 ; [debug line = 206:21@427:73@22:5] [debug variable = v.V]
  store volatile i4 %v.V.1, i4* %this.addr.23, align 1, !dbg !4516 ; [debug line = 365:13@56:100@207:13@427:73@22:5]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, !dbg !4566 ; [debug line = 23:4]

_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge:        ; preds = %4, %3, %2
  %count.0.be = phi i8 [ %v.assign, %4 ], [ %count.3, %2 ], [ %v.assign, %3 ] ; [#uses=1 type=i8]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2

; <label>:3                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i8 %v.assign}, i64 0, metadata !4553), !dbg !4567 ; [debug line = 340:69@26:5] [debug variable = v]
  call void @llvm.dbg.value(metadata !{i8 %v.assign}, i64 0, metadata !4555), !dbg !4570 ; [debug line = 340:69@340:92@26:5] [debug variable = v]
  call void @llvm.dbg.value(metadata !{i8 %v.assign}, i64 0, metadata !4558), !dbg !4572 ; [debug line = 1453:78@340:90@340:92@26:5] [debug variable = op]
  %v.V.2 = trunc i8 %v.assign to i4, !dbg !4574   ; [#uses=1 type=i4] [debug line = 1453:84@340:90@340:92@26:5]
  call void @llvm.dbg.value(metadata !{i4 %v.V.2}, i64 0, metadata !4563), !dbg !4575 ; [debug line = 206:21@427:73@26:5] [debug variable = v.V]
  store volatile i4 %v.V.2, i4* %this.addr.23, align 1, !dbg !4577 ; [debug line = 365:13@56:100@207:13@427:73@26:5]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge

; <label>:4                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  %val.V.4 = load volatile i4* %this.addr.20, align 1, !dbg !4580 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@31:14]
  call void @llvm.dbg.value(metadata !{i4 %val.V.4}, i64 0, metadata !4533), !dbg !4580 ; [debug line = 374:13@60:21@180:66@351:73@31:14] [debug variable = val.V]
  %val.V.5 = load volatile i4* %this.addr.21, align 1, !dbg !4585 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@31:32]
  call void @llvm.dbg.value(metadata !{i4 %val.V.5}, i64 0, metadata !4533), !dbg !4585 ; [debug line = 374:13@60:21@180:66@351:73@31:32] [debug variable = val.V]
  call void @llvm.dbg.value(metadata !{i4 %val.V.4}, i64 0, metadata !4589), !dbg !4592 ; [debug line = 3374:0@31:32] [debug variable = lhs.V]
  call void @llvm.dbg.value(metadata !{i4 %val.V.5}, i64 0, metadata !4593), !dbg !4592 ; [debug line = 3374:0@31:32] [debug variable = rhs.V]
  %r.V = and i4 %val.V.5, %val.V.4, !dbg !4592    ; [#uses=3 type=i4] [debug line = 3374:0@31:32]
  call void @llvm.dbg.value(metadata !{i4 %r.V}, i64 0, metadata !4595), !dbg !4592 ; [debug line = 3374:0@31:32] [debug variable = r.V]
  store i4 %r.V, i4* %this.addr.24, align 1, !dbg !4526 ; [debug line = 378:13@31:32]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %r.V) nounwind
  call void @llvm.dbg.value(metadata !{i4 %r.V}, i64 0, metadata !4563), !dbg !4598 ; [debug line = 206:21@427:73@32:4] [debug variable = v.V]
  store volatile i4 %r.V, i4* %this.addr.23, align 1, !dbg !4601 ; [debug line = 365:13@56:100@207:13@427:73@32:4]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge
}
...
!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!4327, !4334, !4335, !4341, !4347, !4347, !4350, !4350, !4351, !4354, !4350, !4357, !4357, !4360, !4361, !4362, !4363, !4351, !4365, !4367, !4367, !4350, !4369, !4350, !4350, !4371, !4374, !4350, !4350, !4350, !4376, !4378, !4378, !4383, !4385, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4386}
!hls.encrypted.func = !{}
...
!925 = metadata !{i32 786478, i32 0, null, metadata !"iosThread", metadata !"iosThread", metadata !"_ZN4iosc9iosThreadEv", metadata !926, i32 3, metadata !927, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.iosc.12*)* @"iosc::iosThread", null, metadata !1872, metadata !86, i32 4} ; [ DW_TAG_subprogram ]
...
!1888 = metadata !{i32 786478, i32 0, null, metadata !"timeThread", metadata !"timeThread", metadata !"_ZN4iosc10timeThreadEv", metadata !926, i32 37, metadata !927, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.iosc.12*)* @"iosc::timeThread", null, metadata !1873, metadata !86, i32 38} ; [ DW_TAG_subprogram ]
!1889 = metadata !{i32 786478, i32 0, metadata !935, metadata !"write<int>", metadata !"write<int>", metadata !"_ZN7_ap_sc_7sc_core18sc_signal_inout_ifIbE5writeIiEEvRKT_", metadata !937, i32 205, metadata !1890, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1894, null, metadata !86, i32 205} ; [ DW_TAG_subprogram ]
...
!1896 = metadata !{i32 786478, i32 0, metadata !937, metadata !"_ssdm_op_WRITE<bool>", metadata !"_ssdm_op_WRITE<bool>", metadata !"_Z14_ssdm_op_WRITEIbEvRVbRKT_", metadata !937, i32 128, metadata !1897, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1900, null, metadata !86, i32 167} ; [ DW_TAG_subprogram ]
...
!1902 = metadata !{i32 786478, i32 0, metadata !1057, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEC1ERK11ap_int_baseILi4ELb0ELb1EE", metadata !1059, i32 278, metadata !1584, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1583, metadata !86, i32 278} ; [ DW_TAG_subprogram ]
!1903 = metadata !{i32 786478, i32 0, metadata !1057, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEC2ERK11ap_int_baseILi4ELb0ELb1EE", metadata !1059, i32 278, metadata !1584, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1583, metadata !86, i32 278} ; [ DW_TAG_subprogram ]
!1904 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi4ELb0ELb1EEC2Ev", metadata !865, i32 1429, metadata !1078, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1077, metadata !86, i32 1429} ; [ DW_TAG_subprogram ]
!1905 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi4ELb0EEC2Ev", metadata !1066, i32 10, metadata !1071, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1070, metadata !86, i32 10} ; [ DW_TAG_subprogram ]
!1906 = metadata !{i32 786478, i32 0, metadata !1057, metadata !"operator=", metadata !"operator=", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEaSERKS2_", metadata !1059, i32 377, metadata !1663, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1662, metadata !86, i32 377} ; [ DW_TAG_subprogram ]
...
!1913 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi4ELb0ELb1EEC1Ev", metadata !865, i32 1429, metadata !1078, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1077, metadata !86, i32 1429} ; [ DW_TAG_subprogram ]
!1914 = metadata !{i32 786478, i32 0, metadata !1057, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEC1Eh", metadata !1059, i32 340, metadata !1617, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1616, metadata !86, i32 340} ; [ DW_TAG_subprogram ]
!1915 = metadata !{i32 786478, i32 0, metadata !1057, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEC2Eh", metadata !1059, i32 340, metadata !1617, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1616, metadata !86, i32 340} ; [ DW_TAG_subprogram ]
!1916 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi4ELb0ELb1EEC2Eh", metadata !865, i32 1453, metadata !1103, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1102, metadata !86, i32 1453} ; [ DW_TAG_subprogram ]
!1917 = metadata !{i32 786478, i32 0, metadata !935, metadata !"write", metadata !"write", metadata !"_ZN7_ap_sc_7sc_core8sc_inoutINS_5sc_dt7sc_uintILi4EEEE5writeERKS4_", metadata !937, i32 427, metadata !1801, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1800, metadata !86, i32 427} ; [ DW_TAG_subprogram ]
!1918 = metadata !{i32 786478, i32 0, metadata !935, metadata !"write<_ap_sc_::sc_dt::sc_uint<4> >", metadata !"write<_ap_sc_::sc_dt::sc_uint<4> >", metadata !"_ZN7_ap_sc_7sc_core18sc_signal_inout_ifINS_5sc_dt7sc_uintILi4EEEE5writeIS4_EEvRKT_", metadata !937, i32 205, metadata !1919, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1921, null, metadata !86, i32 205} ; [ DW_TAG_subprogram ]
...
!1930 = metadata !{i32 786478, i32 0, metadata !1057, metadata !"operator=", metadata !"operator=", metadata !"_ZNV7_ap_sc_5sc_dt7sc_uintILi4EEaSERKS2_", metadata !1059, i32 364, metadata !1650, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1649, metadata !86, i32 364} ; [ DW_TAG_subprogram ]
!1931 = metadata !{i32 786478, i32 0, metadata !865, metadata !"operator==<4, false>", metadata !"operator==<4, false>", metadata !"_ZeqILi4ELb0EEbRK11ap_int_baseIXT_EXT0_EXleT_Li64EEEi", metadata !865, i32 3571, metadata !1932, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1934, null, metadata !86, i32 3571} ; [ DW_TAG_subprogram ]
...
!1935 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi32ELb1ELb1EEC1Ei", metadata !865, i32 1456, metadata !1936, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1984, metadata !86, i32 1456} ; [ DW_TAG_subprogram ]
...
!2476 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi32ELb1ELb1EEC2Ei", metadata !865, i32 1456, metadata !1936, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1984, metadata !86, i32 1456} ; [ DW_TAG_subprogram ]
!2477 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi32ELb1EEC2Ev", metadata !1066, i32 65, metadata !1947, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1946, metadata !86, i32 65} ; [ DW_TAG_subprogram ]
!2478 = metadata !{i32 786478, i32 0, null, metadata !"operator==<32, true>", metadata !"operator==<32, true>", metadata !"_ZNK11ap_int_baseILi4ELb0ELb1EEeqILi32ELb1EEEbRKS_IXT_EXT0_EXleT_Li64EEE", metadata !865, i32 1978, metadata !2479, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1960, null, metadata !86, i32 1978} ; [ DW_TAG_subprogram ]
...
!2481 = metadata !{i32 786478, i32 0, metadata !935, metadata !"read", metadata !"read", metadata !"_ZN7_ap_sc_7sc_core5sc_inINS_5sc_dt7sc_uintILi4EEEE4readEv", metadata !937, i32 351, metadata !1723, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1722, metadata !86, i32 351} ; [ DW_TAG_subprogram ]
!2482 = metadata !{i32 786478, i32 0, metadata !935, metadata !"read", metadata !"read", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifINS_5sc_dt7sc_uintILi4EEEE4readEv", metadata !937, i32 180, metadata !1673, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1672, metadata !86, i32 180} ; [ DW_TAG_subprogram ]
!2483 = metadata !{i32 786478, i32 0, metadata !937, metadata !"_ssdm_op_READ<4>", metadata !"_ssdm_op_READ<4>", metadata !"_Z13_ssdm_op_READILi4EEN7_ap_sc_5sc_dt7sc_uintIXT_EEERVS3_", metadata !937, i32 105, metadata !2484, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !2486, null, metadata !86, i32 59} ; [ DW_TAG_subprogram ]
...
!2487 = metadata !{i32 786478, i32 0, metadata !1057, metadata !"operator=", metadata !"operator=", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEaSERVKS2_", metadata !1059, i32 373, metadata !1659, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1658, metadata !86, i32 373} ; [ DW_TAG_subprogram ]
!2488 = metadata !{i32 786478, i32 0, metadata !1057, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEC1Ev", metadata !1059, i32 272, metadata !1580, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1579, metadata !86, i32 272} ; [ DW_TAG_subprogram ]
!2489 = metadata !{i32 786478, i32 0, metadata !1057, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEC2Ev", metadata !1059, i32 272, metadata !1580, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1579, metadata !86, i32 272} ; [ DW_TAG_subprogram ]
!2490 = metadata !{i32 786478, i32 0, metadata !935, metadata !"read", metadata !"read", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifIbE4readEv", metadata !937, i32 180, metadata !966, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !965, metadata !86, i32 180} ; [ DW_TAG_subprogram ]
!2491 = metadata !{i32 786478, i32 0, metadata !2492, metadata !"_ssdm_op_READ<bool>", metadata !"_ssdm_op_READ<bool>", metadata !"_Z13_ssdm_op_READIbET_RVS0_", metadata !2492, i32 166, metadata !2493, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !2495, null, metadata !86, i32 166} ; [ DW_TAG_subprogram ]
...
!2497 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_module_name", metadata !"sc_module_name", metadata !"_ZN7_ap_sc_7sc_core14sc_module_nameC1EPKc", metadata !937, i32 594, metadata !1880, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1879, metadata !86, i32 594} ; [ DW_TAG_subprogram ]
!2498 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_module_name", metadata !"sc_module_name", metadata !"_ZN7_ap_sc_7sc_core14sc_module_nameC2EPKc", metadata !937, i32 594, metadata !1880, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1879, metadata !86, i32 594} ; [ DW_TAG_subprogram ]
!2499 = metadata !{i32 786478, i32 0, null, metadata !"iosc", metadata !"iosc", metadata !"_ZN4ioscC1EN7_ap_sc_7sc_core14sc_module_nameE", metadata !931, i32 18, metadata !1875, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1874, metadata !86, i32 19} ; [ DW_TAG_subprogram ]
!2500 = metadata !{i32 786478, i32 0, null, metadata !"iosc", metadata !"iosc", metadata !"_ZN4ioscC2EN7_ap_sc_7sc_core14sc_module_nameE", metadata !931, i32 18, metadata !1875, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.iosc.12*, %"class.std::ios_base::Init.0"*)* @"iosc::iosc", null, metadata !1874, metadata !86, i32 19} ; [ DW_TAG_subprogram ]
!2501 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_signal", metadata !"sc_signal", metadata !"_ZN7_ap_sc_7sc_core9sc_signalIbEC1Ev", metadata !937, i32 326, metadata !1860, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1859, metadata !86, i32 326} ; [ DW_TAG_subprogram ]
!2502 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_signal", metadata !"sc_signal", metadata !"_ZN7_ap_sc_7sc_core9sc_signalIbEC2Ev", metadata !937, i32 326, metadata !1860, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1859, metadata !86, i32 326} ; [ DW_TAG_subprogram ]
!2503 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_signal_inout_if", metadata !"sc_signal_inout_if", metadata !"_ZN7_ap_sc_7sc_core18sc_signal_inout_ifIbEC2Ev", metadata !937, i32 197, metadata !1847, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1846, metadata !86, i32 197} ; [ DW_TAG_subprogram ]
!2504 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_signal_in_if", metadata !"sc_signal_in_if", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifIbEC2Ev", metadata !937, i32 176, metadata !962, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !961, metadata !86, i32 176} ; [ DW_TAG_subprogram ]
!2505 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_interface", metadata !"sc_interface", metadata !"_ZN7_ap_sc_7sc_core12sc_interfaceC2Ev", metadata !937, i32 165, metadata !956, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !955, metadata !86, i32 165} ; [ DW_TAG_subprogram ]
!2506 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_out", metadata !"sc_out", metadata !"_ZN7_ap_sc_7sc_core6sc_outINS_5sc_dt7sc_uintILi4EEEEC1Ev", metadata !937, i32 443, metadata !1826, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1825, metadata !86, i32 443} ; [ DW_TAG_subprogram ]
!2507 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_out", metadata !"sc_out", metadata !"_ZN7_ap_sc_7sc_core6sc_outINS_5sc_dt7sc_uintILi4EEEEC2Ev", metadata !937, i32 443, metadata !1826, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1825, metadata !86, i32 443} ; [ DW_TAG_subprogram ]
!2508 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_inout", metadata !"sc_inout", metadata !"_ZN7_ap_sc_7sc_core8sc_inoutINS_5sc_dt7sc_uintILi4EEEEC2Ev", metadata !937, i32 423, metadata !1794, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1793, metadata !86, i32 423} ; [ DW_TAG_subprogram ]
!2509 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_port_b", metadata !"sc_port_b", metadata !"_ZN7_ap_sc_7sc_core9sc_port_bINS0_18sc_signal_inout_ifINS_5sc_dt7sc_uintILi4EEEEEEC2Ev", metadata !937, i32 285, metadata !1768, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1767, metadata !86, i32 285} ; [ DW_TAG_subprogram ]
!2510 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_signal_inout_if", metadata !"sc_signal_inout_if", metadata !"_ZN7_ap_sc_7sc_core18sc_signal_inout_ifINS_5sc_dt7sc_uintILi4EEEEC1Ev", metadata !937, i32 197, metadata !1755, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1754, metadata !86, i32 197} ; [ DW_TAG_subprogram ]
...
!2512 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_signal_in_if", metadata !"sc_signal_in_if", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifINS_5sc_dt7sc_uintILi4EEEEC2Ev", metadata !937, i32 176, metadata !1669, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1668, metadata !86, i32 176} ; [ DW_TAG_subprogram ]
!2513 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_port_base", metadata !"sc_port_base", metadata !"_ZN7_ap_sc_7sc_core12sc_port_baseC2Ev", metadata !937, i32 278, metadata !946, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !945, metadata !86, i32 278} ; [ DW_TAG_subprogram ]
!2514 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_in", metadata !"sc_in", metadata !"_ZN7_ap_sc_7sc_core5sc_inINS_5sc_dt7sc_uintILi4EEEEC1Ev", metadata !937, i32 347, metadata !1716, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1715, metadata !86, i32 347} ; [ DW_TAG_subprogram ]
!2515 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_in", metadata !"sc_in", metadata !"_ZN7_ap_sc_7sc_core5sc_inINS_5sc_dt7sc_uintILi4EEEEC2Ev", metadata !937, i32 347, metadata !1716, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1715, metadata !86, i32 347} ; [ DW_TAG_subprogram ]
!2516 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_port_b", metadata !"sc_port_b", metadata !"_ZN7_ap_sc_7sc_core9sc_port_bINS0_15sc_signal_in_ifINS_5sc_dt7sc_uintILi4EEEEEEC2Ev", metadata !937, i32 285, metadata !1689, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1688, metadata !86, i32 285} ; [ DW_TAG_subprogram ]
...
!2518 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_in", metadata !"sc_in", metadata !"_ZN7_ap_sc_7sc_core5sc_inIbEC1Ev", metadata !937, i32 378, metadata !1018, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1017, metadata !86, i32 378} ; [ DW_TAG_subprogram ]
!2519 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_in", metadata !"sc_in", metadata !"_ZN7_ap_sc_7sc_core5sc_inIbEC2Ev", metadata !937, i32 378, metadata !1018, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1017, metadata !86, i32 378} ; [ DW_TAG_subprogram ]
!2520 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_port_b", metadata !"sc_port_b", metadata !"_ZN7_ap_sc_7sc_core9sc_port_bINS0_15sc_signal_in_ifIbEEEC2Ev", metadata !937, i32 285, metadata !983, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !982, metadata !86, i32 285} ; [ DW_TAG_subprogram ]
!2521 = metadata !{i32 786478, i32 0, metadata !935, metadata !"sc_signal_in_if", metadata !"sc_signal_in_if", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifIbEC1Ev", metadata !937, i32 176, metadata !962, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !961, metadata !86, i32 176} ; [ DW_TAG_subprogram ]
!2522 = metadata !{i32 786478, i32 0, metadata !935, metadata !"wait", metadata !"wait", metadata !"_ZN7_ap_sc_7sc_core4waitEi", metadata !937, i32 802, metadata !2523, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !86, i32 802} ; [ DW_TAG_subprogram ]
...
!2575 = metadata !{i32 786484, i32 0, metadata !2576, metadata !"__ioinit", metadata !"__ioinit", metadata !"_ZStL8__ioinit", metadata !2577, i32 72, metadata !2578, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!2588 = metadata !{i32 786484, i32 0, null, metadata !"ssdm_ins_iosc_0_0", metadata !"ssdm_ins_iosc_0_0", metadata !"", metadata !926, i32 59, metadata !930, i32 0, i32 1, %struct.iosc.12* @ssdm_ins_iosc_0_0} ; [ DW_TAG_variable ]
!2589 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer11__is_signedE", metadata !2590, i32 71, metadata !976, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2591 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !2590, i32 74, metadata !1893, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2592 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !2590, i32 109, metadata !1893, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2593 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating11__is_signedE", metadata !2590, i32 112, metadata !976, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2594 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !2590, i32 115, metadata !1893, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2595 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !2590, i32 118, metadata !1893, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2596 = metadata !{i32 786484, i32 0, null, metadata !"__globallocalestatus", metadata !"__globallocalestatus", metadata !"", metadata !2597, i32 76, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2598 = metadata !{i32 786484, i32 0, null, metadata !"__locale_changed", metadata !"__locale_changed", metadata !"", metadata !2597, i32 77, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2599 = metadata !{i32 786484, i32 0, null, metadata !"__initiallocinfo", metadata !"__initiallocinfo", metadata !"", metadata !2597, i32 78, metadata !2600, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2669 = metadata !{i32 786484, i32 0, null, metadata !"__initiallocalestructinfo", metadata !"__initiallocalestructinfo", metadata !"", metadata !2597, i32 79, metadata !2670, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2680 = metadata !{i32 786484, i32 0, null, metadata !"_imp____mb_cur_max", metadata !"_imp____mb_cur_max", metadata !"", metadata !2597, i32 193, metadata !149, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2681 = metadata !{i32 786484, i32 0, null, metadata !"_CRT_MT", metadata !"_CRT_MT", metadata !"", metadata !2682, i32 374, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2683 = metadata !{i32 786484, i32 0, metadata !2684, metadata !"nothrow", metadata !"nothrow", metadata !"_ZSt7nothrow", metadata !2685, i32 70, metadata !2686, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2688 = metadata !{i32 786484, i32 0, metadata !113, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !115, i32 305, metadata !2689, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2694 = metadata !{i32 786484, i32 0, metadata !126, metadata !"_S_c_locale", metadata !"_S_c_locale", metadata !"_ZNSt6locale5facet11_S_c_localeE", metadata !115, i32 345, metadata !146, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2695 = metadata !{i32 786484, i32 0, metadata !126, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !115, i32 351, metadata !2689, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2696 = metadata !{i32 786484, i32 0, metadata !225, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !115, i32 451, metadata !81, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2697 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !115, i32 626, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2698 = metadata !{i32 786484, i32 0, metadata !2578, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !5, i32 539, metadata !81, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2699 = metadata !{i32 786484, i32 0, metadata !2578, metadata !"_S_synced_with_stdio", metadata !"_S_synced_with_stdio", metadata !"_ZNSt8ios_base4Init20_S_synced_with_stdioE", metadata !5, i32 540, metadata !212, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2700 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !2701, i32 611, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2805 = metadata !{i32 786484, i32 0, metadata !2719, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !2701, i32 694, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2806 = metadata !{i32 786484, i32 0, metadata !2807, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !2701, i32 1196, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2938 = metadata !{i32 786484, i32 0, metadata !2939, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !2701, i32 1538, metadata !150, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2945 = metadata !{i32 786484, i32 0, metadata !2939, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !2701, i32 1542, metadata !150, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2946 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !2701, i32 1651, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2947 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !2701, i32 1919, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2948 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !2701, i32 2257, metadata !225, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2949 = metadata !{i32 786484, i32 0, metadata !2576, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !2577, i32 58, metadata !2950, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3626 = metadata !{i32 786484, i32 0, metadata !2576, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !2577, i32 59, metadata !3627, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3628 = metadata !{i32 786484, i32 0, metadata !2576, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !2577, i32 60, metadata !3627, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3629 = metadata !{i32 786484, i32 0, metadata !2576, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !2577, i32 61, metadata !3627, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3630 = metadata !{i32 786484, i32 0, metadata !2576, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !2577, i32 64, metadata !3631, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!4299 = metadata !{i32 786484, i32 0, metadata !2576, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !2577, i32 65, metadata !4300, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!4301 = metadata !{i32 786484, i32 0, metadata !2576, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !2577, i32 66, metadata !4300, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!4302 = metadata !{i32 786484, i32 0, metadata !2576, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !2577, i32 67, metadata !4300, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!4303 = metadata !{i32 786484, i32 0, metadata !935, metadata !"SC_BIND_PROXY_NIL", metadata !"SC_BIND_PROXY_NIL", metadata !"_ZN7_ap_sc_7sc_core17SC_BIND_PROXY_NILE", metadata !937, i32 518, metadata !4304, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!4323 = metadata !{i32 786484, i32 0, metadata !930, metadata !"__ssdm_thread_M_iosThread", metadata !"__ssdm_thread_M_iosThread", metadata !"_ZN4iosc25__ssdm_thread_M_iosThreadE", metadata !931, i32 7, metadata !212, i32 0, i32 1, i1* @"iosc::__ssdm_thread_M_iosThread"} ; [ DW_TAG_variable ]
!4324 = metadata !{i32 786484, i32 0, metadata !930, metadata !"__ssdm_thread_M_timeThread", metadata !"__ssdm_thread_M_timeThread", metadata !"_ZN4iosc26__ssdm_thread_M_timeThreadE", metadata !931, i32 8, metadata !212, i32 0, i32 1, i1* @"iosc::__ssdm_thread_M_timeThread"} ; [ DW_TAG_variable ]
...
!4327 = metadata !{void (%struct.iosc.12*)* @"iosc::iosThread", metadata !4328, metadata !4329, metadata !4330, metadata !4331, metadata !4332, metadata !4333}
...
!4334 = metadata !{void (%struct.iosc.12*)* @"iosc::timeThread", metadata !4328, metadata !4329, metadata !4330, metadata !4331, metadata !4332, metadata !4333}
!4335 = metadata !{null, metadata !4336, metadata !4337, metadata !4338, metadata !4339, metadata !4340, metadata !4333}
...
!4341 = metadata !{null, metadata !4342, metadata !4343, metadata !4344, metadata !4345, metadata !4346, metadata !4333}
...
!4347 = metadata !{null, metadata !4336, metadata !4337, metadata !4348, metadata !4339, metadata !4349, metadata !4333}
!4348 = metadata !{metadata !"kernel_arg_type", metadata !"const sc_uint_base &"}
!4349 = metadata !{metadata !"kernel_arg_name", metadata !"op"}
!4350 = metadata !{null, metadata !4328, metadata !4329, metadata !4330, metadata !4331, metadata !4332, metadata !4333}
!4351 = metadata !{null, metadata !4336, metadata !4337, metadata !4352, metadata !4339, metadata !4353, metadata !4333}
!4352 = metadata !{metadata !"kernel_arg_type", metadata !"const struct _ap_sc_::sc_dt::sc_uint<4> &"}
!4353 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!4354 = metadata !{null, metadata !4342, metadata !4343, metadata !4355, metadata !4345, metadata !4356, metadata !4333}
!4355 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<4, false> &", metadata !"const ap_int_base<4, false> &"}
!4356 = metadata !{metadata !"kernel_arg_name", metadata !"op", metadata !"op2"}
!4357 = metadata !{null, metadata !4336, metadata !4337, metadata !4358, metadata !4339, metadata !4359, metadata !4333}
!4358 = metadata !{metadata !"kernel_arg_type", metadata !"uchar"}
!4359 = metadata !{metadata !"kernel_arg_name", metadata !"v"}
!4360 = metadata !{null, metadata !4336, metadata !4337, metadata !4358, metadata !4339, metadata !4349, metadata !4333}
!4361 = metadata !{null, metadata !4336, metadata !4337, metadata !4352, metadata !4339, metadata !4359, metadata !4333}
!4362 = metadata !{null, metadata !4336, metadata !4337, metadata !4352, metadata !4339, metadata !4340, metadata !4333}
!4363 = metadata !{null, metadata !4342, metadata !4343, metadata !4364, metadata !4345, metadata !4346, metadata !4333}
!4364 = metadata !{metadata !"kernel_arg_type", metadata !"volatile sc_uint<4> &", metadata !"const struct _ap_sc_::sc_dt::sc_uint<4> &"}
!4365 = metadata !{null, metadata !4342, metadata !4343, metadata !4366, metadata !4345, metadata !4356, metadata !4333}
!4366 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<4, false> &", metadata !"int"}
!4367 = metadata !{null, metadata !4336, metadata !4337, metadata !4368, metadata !4339, metadata !4349, metadata !4333}
!4368 = metadata !{metadata !"kernel_arg_type", metadata !"int"}
!4369 = metadata !{null, metadata !4336, metadata !4337, metadata !4370, metadata !4339, metadata !4353, metadata !4333}
!4370 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<32, true> &"}
!4371 = metadata !{null, metadata !4336, metadata !4337, metadata !4372, metadata !4339, metadata !4373, metadata !4333}
!4372 = metadata !{metadata !"kernel_arg_type", metadata !"volatile sc_uint<4> &"}
!4373 = metadata !{metadata !"kernel_arg_name", metadata !"P"}
!4374 = metadata !{null, metadata !4336, metadata !4337, metadata !4375, metadata !4339, metadata !4353, metadata !4333}
!4375 = metadata !{metadata !"kernel_arg_type", metadata !"const volatile struct _ap_sc_::sc_dt::sc_uint<4> &"}
!4376 = metadata !{null, metadata !4336, metadata !4337, metadata !4377, metadata !4339, metadata !4373, metadata !4333}
!4377 = metadata !{metadata !"kernel_arg_type", metadata !"volatile _Bool &"}
!4378 = metadata !{null, metadata !4379, metadata !4337, metadata !4380, metadata !4381, metadata !4382, metadata !4333}
!4379 = metadata !{metadata !"kernel_arg_addr_space", i32 1}
!4380 = metadata !{metadata !"kernel_arg_type", metadata !"char*"}
!4381 = metadata !{metadata !"kernel_arg_type_qual", metadata !"const"}
!4382 = metadata !{metadata !"kernel_arg_name", metadata !""}
!4383 = metadata !{null, metadata !4336, metadata !4337, metadata !4384, metadata !4339, metadata !4382, metadata !4333}
!4384 = metadata !{metadata !"kernel_arg_type", metadata !"::sc_core::sc_module_name"}
!4385 = metadata !{void (%struct.iosc.12*, %"class.std::ios_base::Init.0"*)* @"iosc::iosc", metadata !4336, metadata !4337, metadata !4384, metadata !4339, metadata !4382, metadata !4333}
!4386 = metadata !{null, metadata !4336, metadata !4337, metadata !4368, metadata !4339, metadata !4387, metadata !4333}
!4387 = metadata !{metadata !"kernel_arg_name", metadata !"n"}
!4388 = metadata !{i32 786689, metadata !1888, metadata !"this", metadata !926, i32 16777253, metadata !4389, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4389 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !930} ; [ DW_TAG_pointer_type ]
!4390 = metadata !{i32 37, i32 12, metadata !1888, null}
!4391 = metadata !{i32 38, i32 4, metadata !4392, null}
!4392 = metadata !{i32 786443, metadata !1888, i32 38, i32 1, metadata !926, i32 7} ; [ DW_TAG_lexical_block ]
!4393 = metadata !{i32 39, i32 3, metadata !4392, null}
!4394 = metadata !{i32 40, i32 3, metadata !4392, null}
!4395 = metadata !{i32 41, i32 3, metadata !4392, null}
!4396 = metadata !{i32 42, i32 3, metadata !4392, null}
!4397 = metadata !{i32 43, i32 3, metadata !4392, null}
!4398 = metadata !{i32 43, i32 85, metadata !4392, null}
!4399 = metadata !{i32 43, i32 106, metadata !4392, null}
!4400 = metadata !{i32 43, i32 143, metadata !4392, null}
!4401 = metadata !{i32 43, i32 190, metadata !4392, null}
!4402 = metadata !{i32 43, i32 240, metadata !4392, null}
!4403 = metadata !{i32 786688, metadata !4392, metadata !"_ssdm_reset_v", metadata !926, i32 43, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4404 = metadata !{i32 44, i32 1, metadata !4392, null}
!4405 = metadata !{i32 45, i32 1, metadata !4392, null}
!4406 = metadata !{i32 46, i32 1, metadata !4392, null}
!4407 = metadata !{i32 47, i32 1, metadata !4392, null}
!4408 = metadata !{i32 48, i32 1, metadata !4392, null}
!4409 = metadata !{i32 49, i32 1, metadata !4392, null}
!4410 = metadata !{i32 50, i32 1, metadata !4392, null}
!4411 = metadata !{i32 51, i32 44, metadata !4392, null}
!4412 = metadata !{i32 51, i32 82, metadata !4392, null}
!4413 = metadata !{i32 803, i32 19, metadata !4414, metadata !4416}
!4414 = metadata !{i32 786443, metadata !4415, i32 803, i32 17, metadata !937, i32 52} ; [ DW_TAG_lexical_block ]
!4415 = metadata !{i32 786443, metadata !2522, i32 802, i32 58, metadata !937, i32 51} ; [ DW_TAG_lexical_block ]
!4416 = metadata !{i32 39, i32 1, metadata !4392, null}
!4417 = metadata !{i32 207, i32 13, metadata !4418, metadata !4419}
!4418 = metadata !{i32 786443, metadata !1889, i32 205, i32 73, metadata !937, i32 11} ; [ DW_TAG_lexical_block ]
!4419 = metadata !{i32 41, i32 1, metadata !4392, null}
!4420 = metadata !{i32 786689, metadata !1896, metadata !"P", metadata !937, i32 16777344, metadata !1899, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4421 = metadata !{i32 128, i32 96, metadata !1896, metadata !4417}
!4422 = metadata !{i32 167, i32 116, metadata !4423, metadata !4417}
!4423 = metadata !{i32 786443, metadata !1896, i32 167, i32 114, metadata !2492, i32 12} ; [ DW_TAG_lexical_block ]
!4424 = metadata !{i32 41, i32 17, metadata !4392, null}
!4425 = metadata !{i32 803, i32 19, metadata !4414, metadata !4426}
!4426 = metadata !{i32 44, i32 3, metadata !4427, null}
!4427 = metadata !{i32 786443, metadata !4392, i32 43, i32 1, metadata !926, i32 8} ; [ DW_TAG_lexical_block ]
!4428 = metadata !{i32 45, i32 3, metadata !4427, null}
!4429 = metadata !{i32 47, i32 4, metadata !4430, null}
!4430 = metadata !{i32 786443, metadata !4427, i32 46, i32 3, metadata !926, i32 9} ; [ DW_TAG_lexical_block ]
!4431 = metadata !{i32 786688, metadata !4392, metadata !"count", metadata !926, i32 40, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4432 = metadata !{i32 128, i32 96, metadata !1896, metadata !4433}
!4433 = metadata !{i32 207, i32 13, metadata !4418, metadata !4434}
!4434 = metadata !{i32 48, i32 4, metadata !4430, null}
!4435 = metadata !{i32 167, i32 116, metadata !4423, metadata !4433}
!4436 = metadata !{i32 49, i32 3, metadata !4430, null}
!4437 = metadata !{i32 128, i32 96, metadata !1896, metadata !4438}
!4438 = metadata !{i32 207, i32 13, metadata !4418, metadata !4439}
!4439 = metadata !{i32 53, i32 4, metadata !4440, null}
!4440 = metadata !{i32 786443, metadata !4427, i32 51, i32 3, metadata !926, i32 10} ; [ DW_TAG_lexical_block ]
!4441 = metadata !{i32 167, i32 116, metadata !4423, metadata !4438}
!4442 = metadata !{i32 786689, metadata !2500, metadata !"this", metadata !931, i32 16777234, metadata !4389, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4443 = metadata !{i32 18, i32 3, metadata !2500, null}
!4444 = metadata !{i32 20, i32 5, metadata !4445, null}
!4445 = metadata !{i32 786443, metadata !2500, i32 19, i32 2, metadata !931, i32 36} ; [ DW_TAG_lexical_block ]
!4446 = metadata !{i32 20, i32 65, metadata !4445, null}
!4447 = metadata !{i32 21, i32 5, metadata !4445, null}
!4448 = metadata !{i32 21, i32 36, metadata !4445, null}
!4449 = metadata !{i32 21, i32 49, metadata !4445, null}
!4450 = metadata !{i32 22, i32 5, metadata !4445, null}
!4451 = metadata !{i32 23, i32 5, metadata !4445, null}
!4452 = metadata !{i32 24, i32 5, metadata !4445, null}
!4453 = metadata !{i32 24, i32 37, metadata !4445, null}
!4454 = metadata !{i32 24, i32 51, metadata !4445, null}
!4455 = metadata !{i32 25, i32 5, metadata !4445, null}
!4456 = metadata !{i32 26, i32 5, metadata !4445, null}
!4457 = metadata !{i32 27, i32 5, metadata !4445, null}
!4458 = metadata !{i32 28, i32 5, metadata !4445, null}
!4459 = metadata !{i32 29, i32 5, metadata !4445, null}
!4460 = metadata !{i32 30, i32 5, metadata !4445, null}
!4461 = metadata !{i32 31, i32 5, metadata !4445, null}
!4462 = metadata !{i32 32, i32 1, metadata !4445, null}
!4463 = metadata !{i32 33, i32 1, metadata !4445, null}
!4464 = metadata !{i32 34, i32 1, metadata !4445, null}
!4465 = metadata !{i32 35, i32 1, metadata !4445, null}
!4466 = metadata !{i32 36, i32 1, metadata !4445, null}
!4467 = metadata !{i32 37, i32 1, metadata !4445, null}
!4468 = metadata !{i32 38, i32 1, metadata !4445, null}
!4469 = metadata !{i32 29, i32 1, metadata !4445, null}
!4470 = metadata !{i32 786689, metadata !925, metadata !"this", metadata !926, i32 16777219, metadata !4389, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4471 = metadata !{i32 3, i32 12, metadata !925, null}
!4472 = metadata !{i32 4, i32 4, metadata !4473, null}
!4473 = metadata !{i32 786443, metadata !925, i32 4, i32 1, metadata !926, i32 0} ; [ DW_TAG_lexical_block ]
!4474 = metadata !{i32 5, i32 3, metadata !4473, null}
!4475 = metadata !{i32 6, i32 3, metadata !4473, null}
!4476 = metadata !{i32 7, i32 3, metadata !4473, null}
!4477 = metadata !{i32 8, i32 3, metadata !4473, null}
!4478 = metadata !{i32 9, i32 3, metadata !4473, null}
!4479 = metadata !{i32 9, i32 84, metadata !4473, null}
!4480 = metadata !{i32 9, i32 105, metadata !4473, null}
!4481 = metadata !{i32 9, i32 142, metadata !4473, null}
!4482 = metadata !{i32 9, i32 189, metadata !4473, null}
!4483 = metadata !{i32 9, i32 239, metadata !4473, null}
!4484 = metadata !{i32 786688, metadata !4473, metadata !"_ssdm_reset_v", metadata !926, i32 9, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4485 = metadata !{i32 10, i32 1, metadata !4473, null}
!4486 = metadata !{i32 11, i32 1, metadata !4473, null}
!4487 = metadata !{i32 12, i32 1, metadata !4473, null}
!4488 = metadata !{i32 13, i32 1, metadata !4473, null}
!4489 = metadata !{i32 14, i32 1, metadata !4473, null}
!4490 = metadata !{i32 15, i32 1, metadata !4473, null}
!4491 = metadata !{i32 16, i32 1, metadata !4473, null}
!4492 = metadata !{i32 5, i32 1, metadata !4473, null}
!4493 = metadata !{i32 5, i32 92, metadata !4473, null}
!4494 = metadata !{i32 5, i32 130, metadata !4473, null}
!4495 = metadata !{i32 803, i32 19, metadata !4414, metadata !4496}
!4496 = metadata !{i32 8, i32 1, metadata !4473, null}
!4497 = metadata !{i32 374, i32 13, metadata !4498, metadata !4499}
!4498 = metadata !{i32 786443, metadata !2487, i32 373, i32 97, metadata !1059, i32 31} ; [ DW_TAG_lexical_block ]
!4499 = metadata !{i32 60, i32 21, metadata !4500, metadata !4501}
!4500 = metadata !{i32 786443, metadata !2483, i32 59, i32 88, metadata !2492, i32 30} ; [ DW_TAG_lexical_block ]
!4501 = metadata !{i32 180, i32 66, metadata !4502, metadata !4503}
!4502 = metadata !{i32 786443, metadata !2482, i32 180, i32 56, metadata !937, i32 29} ; [ DW_TAG_lexical_block ]
!4503 = metadata !{i32 351, i32 73, metadata !4504, metadata !4505}
!4504 = metadata !{i32 786443, metadata !2481, i32 351, i32 64, metadata !937, i32 28} ; [ DW_TAG_lexical_block ]
!4505 = metadata !{i32 14, i32 7, metadata !4506, null}
!4506 = metadata !{i32 786443, metadata !4473, i32 11, i32 1, metadata !926, i32 1} ; [ DW_TAG_lexical_block ]
!4507 = metadata !{i32 374, i32 13, metadata !4498, metadata !4508}
!4508 = metadata !{i32 60, i32 21, metadata !4500, metadata !4509}
!4509 = metadata !{i32 180, i32 66, metadata !4502, metadata !4510}
!4510 = metadata !{i32 351, i32 73, metadata !4504, metadata !4511}
!4511 = metadata !{i32 18, i32 7, metadata !4506, null}
!4512 = metadata !{i32 180, i32 66, metadata !4513, metadata !4514}
!4513 = metadata !{i32 786443, metadata !2490, i32 180, i32 56, metadata !937, i32 33} ; [ DW_TAG_lexical_block ]
!4514 = metadata !{i32 20, i32 8, metadata !4515, null}
!4515 = metadata !{i32 786443, metadata !4506, i32 19, i32 3, metadata !926, i32 3} ; [ DW_TAG_lexical_block ]
!4516 = metadata !{i32 365, i32 13, metadata !4517, metadata !4518}
!4517 = metadata !{i32 786443, metadata !1930, i32 364, i32 86, metadata !1059, i32 23} ; [ DW_TAG_lexical_block ]
!4518 = metadata !{i32 56, i32 100, metadata !4519, metadata !4520}
!4519 = metadata !{i32 786443, metadata !1923, i32 56, i32 98, metadata !2492, i32 22} ; [ DW_TAG_lexical_block ]
!4520 = metadata !{i32 207, i32 13, metadata !4521, metadata !4522}
!4521 = metadata !{i32 786443, metadata !1918, i32 205, i32 73, metadata !937, i32 21} ; [ DW_TAG_lexical_block ]
!4522 = metadata !{i32 427, i32 73, metadata !4523, metadata !4524}
!4523 = metadata !{i32 786443, metadata !1917, i32 427, i32 71, metadata !937, i32 20} ; [ DW_TAG_lexical_block ]
!4524 = metadata !{i32 22, i32 5, metadata !4525, null}
!4525 = metadata !{i32 786443, metadata !4515, i32 21, i32 4, metadata !926, i32 4} ; [ DW_TAG_lexical_block ]
!4526 = metadata !{i32 378, i32 13, metadata !4527, metadata !4528}
!4527 = metadata !{i32 786443, metadata !1906, i32 377, i32 88, metadata !1059, i32 16} ; [ DW_TAG_lexical_block ]
!4528 = metadata !{i32 31, i32 32, metadata !4529, null}
!4529 = metadata !{i32 786443, metadata !4506, i32 30, i32 3, metadata !926, i32 6} ; [ DW_TAG_lexical_block ]
!4530 = metadata !{i32 9, i32 26, metadata !4473, null}
!4531 = metadata !{i32 803, i32 19, metadata !4414, metadata !4532}
!4532 = metadata !{i32 13, i32 3, metadata !4506, null}
!4533 = metadata !{i32 790529, metadata !4534, metadata !"val.V", null, i32 60, metadata !4535, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4534 = metadata !{i32 786688, metadata !4500, metadata !"val", metadata !2492, i32 60, metadata !1661, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4535 = metadata !{i32 786438, metadata !1057, metadata !"sc_uint<4>", metadata !1059, i32 269, i64 4, i64 8, i32 0, i32 0, null, metadata !4536, i32 0, null, metadata !1666} ; [ DW_TAG_class_field_type ]
!4536 = metadata !{metadata !4537}
!4537 = metadata !{i32 786438, null, metadata !"ap_int_base<4, false, true>", metadata !865, i32 1388, i64 4, i64 8, i32 0, i32 0, null, metadata !4538, i32 0, null, metadata !1577} ; [ DW_TAG_class_field_type ]
!4538 = metadata !{metadata !4539}
!4539 = metadata !{i32 786438, null, metadata !"ssdm_int<4 + 1024 * 0, false>", metadata !1066, i32 10, i64 4, i64 8, i32 0, i32 0, null, metadata !4540, i32 0, null, metadata !1074} ; [ DW_TAG_class_field_type ]
!4540 = metadata !{metadata !1068}
!4541 = metadata !{i32 1979, i32 9, metadata !4542, metadata !4543}
!4542 = metadata !{i32 786443, metadata !2478, i32 1978, i32 107, metadata !865, i32 27} ; [ DW_TAG_lexical_block ]
!4543 = metadata !{i32 3571, i32 144, metadata !4544, metadata !4505}
!4544 = metadata !{i32 786443, metadata !1931, i32 3571, i32 135, metadata !865, i32 24} ; [ DW_TAG_lexical_block ]
!4545 = metadata !{i32 1979, i32 9, metadata !4542, metadata !4546}
!4546 = metadata !{i32 3571, i32 144, metadata !4544, metadata !4511}
!4547 = metadata !{i32 786689, metadata !2491, metadata !"P", metadata !2492, i32 16777382, metadata !1899, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4548 = metadata !{i32 166, i32 90, metadata !2491, metadata !4512}
!4549 = metadata !{i32 166, i32 95, metadata !4550, metadata !4512}
!4550 = metadata !{i32 786443, metadata !2491, i32 166, i32 93, metadata !2492, i32 34} ; [ DW_TAG_lexical_block ]
!4551 = metadata !{i32 786688, metadata !4513, metadata !"tmp", metadata !937, i32 180, metadata !212, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4552 = metadata !{i32 786688, metadata !4473, metadata !"count", metadata !926, i32 9, metadata !1105, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4553 = metadata !{i32 786689, metadata !1914, metadata !"v", metadata !1059, i32 33554772, metadata !1105, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4554 = metadata !{i32 340, i32 69, metadata !1914, metadata !4524}
!4555 = metadata !{i32 786689, metadata !1915, metadata !"v", metadata !1059, i32 33554772, metadata !1105, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4556 = metadata !{i32 340, i32 69, metadata !1915, metadata !4557}
!4557 = metadata !{i32 340, i32 92, metadata !1914, metadata !4524}
!4558 = metadata !{i32 786689, metadata !1916, metadata !"op", metadata !865, i32 33555885, metadata !1105, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4559 = metadata !{i32 1453, i32 78, metadata !1916, metadata !4560}
!4560 = metadata !{i32 340, i32 90, metadata !1915, metadata !4557}
!4561 = metadata !{i32 1453, i32 84, metadata !4562, metadata !4560}
!4562 = metadata !{i32 786443, metadata !1916, i32 1453, i32 82, metadata !865, i32 19} ; [ DW_TAG_lexical_block ]
!4563 = metadata !{i32 790529, metadata !4564, metadata !"v.V", null, i32 206, metadata !4535, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4564 = metadata !{i32 786688, metadata !4521, metadata !"v", metadata !937, i32 206, metadata !1056, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4565 = metadata !{i32 206, i32 21, metadata !4521, metadata !4522}
!4566 = metadata !{i32 23, i32 4, metadata !4525, null}
!4567 = metadata !{i32 340, i32 69, metadata !1914, metadata !4568}
!4568 = metadata !{i32 26, i32 5, metadata !4569, null}
!4569 = metadata !{i32 786443, metadata !4515, i32 25, i32 4, metadata !926, i32 5} ; [ DW_TAG_lexical_block ]
!4570 = metadata !{i32 340, i32 69, metadata !1915, metadata !4571}
!4571 = metadata !{i32 340, i32 92, metadata !1914, metadata !4568}
!4572 = metadata !{i32 1453, i32 78, metadata !1916, metadata !4573}
!4573 = metadata !{i32 340, i32 90, metadata !1915, metadata !4571}
!4574 = metadata !{i32 1453, i32 84, metadata !4562, metadata !4573}
!4575 = metadata !{i32 206, i32 21, metadata !4521, metadata !4576}
!4576 = metadata !{i32 427, i32 73, metadata !4523, metadata !4568}
!4577 = metadata !{i32 365, i32 13, metadata !4517, metadata !4578}
!4578 = metadata !{i32 56, i32 100, metadata !4519, metadata !4579}
!4579 = metadata !{i32 207, i32 13, metadata !4521, metadata !4576}
!4580 = metadata !{i32 374, i32 13, metadata !4498, metadata !4581}
!4581 = metadata !{i32 60, i32 21, metadata !4500, metadata !4582}
!4582 = metadata !{i32 180, i32 66, metadata !4502, metadata !4583}
!4583 = metadata !{i32 351, i32 73, metadata !4504, metadata !4584}
!4584 = metadata !{i32 31, i32 14, metadata !4529, null}
!4585 = metadata !{i32 374, i32 13, metadata !4498, metadata !4586}
!4586 = metadata !{i32 60, i32 21, metadata !4500, metadata !4587}
!4587 = metadata !{i32 180, i32 66, metadata !4502, metadata !4588}
!4588 = metadata !{i32 351, i32 73, metadata !4504, metadata !4528}
!4589 = metadata !{i32 790529, metadata !4590, metadata !"lhs.V", null, i32 3374, metadata !4537, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4590 = metadata !{i32 786688, metadata !4591, metadata !"lhs", metadata !865, i32 3374, metadata !1910, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4591 = metadata !{i32 786443, metadata !1907, i32 3374, i32 256, metadata !865, i32 17} ; [ DW_TAG_lexical_block ]
!4592 = metadata !{i32 3374, i32 0, metadata !4591, metadata !4528}
!4593 = metadata !{i32 790529, metadata !4594, metadata !"rhs.V", null, i32 3374, metadata !4537, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4594 = metadata !{i32 786688, metadata !4591, metadata !"rhs", metadata !865, i32 3374, metadata !1910, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4595 = metadata !{i32 790529, metadata !4596, metadata !"r.V", null, i32 3374, metadata !4537, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4596 = metadata !{i32 786688, metadata !4591, metadata !"r", metadata !865, i32 3374, metadata !4597, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4597 = metadata !{i32 786448, null, null, null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !1910} ; [ DW_TAG_reference_type ]
!4598 = metadata !{i32 206, i32 21, metadata !4521, metadata !4599}
!4599 = metadata !{i32 427, i32 73, metadata !4523, metadata !4600}
!4600 = metadata !{i32 32, i32 4, metadata !4529, null}
!4601 = metadata !{i32 365, i32 13, metadata !4517, metadata !4602}
!4602 = metadata !{i32 56, i32 100, metadata !4519, metadata !4603}
!4603 = metadata !{i32 207, i32 13, metadata !4521, metadata !4599}

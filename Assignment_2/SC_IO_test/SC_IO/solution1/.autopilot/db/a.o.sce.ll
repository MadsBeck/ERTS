...
_ZN7_ap_sc_7sc_core4waitEi.exit:
  %count = alloca i32
  call void @llvm.dbg.declare(metadata !{i32* %count}, metadata !75)
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %clk), !map !1058
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %reset), !map !1062
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %ctrl), !map !1066
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %inSwitch), !map !1070
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %outLeds), !map !1074
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %timer), !map !1078
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_switchs_V), !map !1082
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !1086), !dbg !1098
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !1099), !dbg !1098
  call void @llvm.dbg.value(metadata !{i4* %ctrl}, i64 0, metadata !1100), !dbg !1098
  call void @llvm.dbg.value(metadata !{i4* %inSwitch}, i64 0, metadata !1116), !dbg !1098
  call void @llvm.dbg.value(metadata !{i4* %outLeds}, i64 0, metadata !1117), !dbg !1098
  call void @llvm.dbg.value(metadata !{i1* %timer}, i64 0, metadata !1128), !dbg !1098
  call void @llvm.dbg.value(metadata !{i4* %iosc_switchs_V}, i64 0, metadata !1135), !dbg !1098
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !1138
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !1139
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %ctrl) nounwind, !dbg !1140
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %inSwitch) nounwind, !dbg !1141
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %outLeds) nounwind, !dbg !1142
  call void (...)* @_ssdm_op_SpecProcessDef([5 x i8]* @p_str, i32 2, [11 x i8]* @p_str16) nounwind, !dbg !1143
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !1144
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !1145
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !1146
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !1147), !dbg !1146
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !1148
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp_1), !dbg !1149
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1150
  call void @llvm.dbg.value(metadata !{i1* %timer}, i64 0, metadata !1157), !dbg !1164
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %timer, i1 false), !dbg !1175
  store i32 0, i32* %count
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2, !dbg !1178

_ZN7_ap_sc_7sc_core4waitEi.exit2:                 ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, %_ZN7_ap_sc_7sc_core4waitEi.exit
  %count_load = load i32* %count, !dbg !1179
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1182
  %tmp = icmp slt i32 %count_load, 100000000, !dbg !1184
  br i1 %tmp, label %0, label %1, !dbg !1184

; <label>:0                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  %count_1 = add nsw i32 %count_load, 1, !dbg !1179
  call void @llvm.dbg.value(metadata !{i32 %count_1}, i64 0, metadata !75), !dbg !1179
  call void @llvm.dbg.value(metadata !{i1* %timer}, i64 0, metadata !1157), !dbg !1185
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %timer, i1 false), !dbg !1188
  store i32 %count_1, i32* %count, !dbg !1179
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, !dbg !1189

; <label>:1                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  call void @llvm.dbg.value(metadata !{i1* %timer}, i64 0, metadata !1157), !dbg !1190
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %timer, i1 true), !dbg !1194
  store i32 0, i32* %count
...
define weak void @"iosc::iosc"(i1* %clk, i1* %reset, i4* %ctrl, i4* %inSwitch, i4* %outLeds, i1* %timer, i4* %iosc_switchs_V) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %timer), !map !1078
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_switchs_V), !map !1082
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !1195), !dbg !1198
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !1199), !dbg !1198
  call void @llvm.dbg.value(metadata !{i4* %ctrl}, i64 0, metadata !1200), !dbg !1198
  call void @llvm.dbg.value(metadata !{i4* %inSwitch}, i64 0, metadata !1201), !dbg !1198
  call void @llvm.dbg.value(metadata !{i4* %outLeds}, i64 0, metadata !1202), !dbg !1198
  call void @llvm.dbg.value(metadata !{i1* %timer}, i64 0, metadata !1203), !dbg !1198
  call void @llvm.dbg.value(metadata !{i4* %iosc_switchs_V}, i64 0, metadata !1204), !dbg !1198
  call void (...)* @_ssdm_op_SpecTopModule([5 x i8]* @p_str, [5 x i8]* @p_str) nounwind, !dbg !1205
  %iosc_ssdm_thread_s = load i1* @iosc_ssdm_thread_M_iosThread, align 1, !dbg !1207
  br i1 %iosc_ssdm_thread_s, label %1, label %2, !dbg !1207

; <label>:1                                       ; preds = %0
  call void @"iosc::iosThread"(i1* %clk, i1* %reset, i4* %ctrl, i4* %inSwitch, i4* %outLeds, i1* %timer, i4* %iosc_switchs_V), !dbg !1208
  br label %UnifiedUnreachableBlock

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([5 x i8]* @p_str, i32 2, [10 x i8]* @p_str8) nounwind, !dbg !1209
  call void (...)* @_ssdm_op_SpecSensitive([10 x i8]* @p_str8, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !1210
  call void (...)* @_ssdm_op_SpecSensitive([10 x i8]* @p_str8, [6 x i8]* @p_str3, i1* %reset, i32 3) nounwind, !dbg !1211
  %iosc_ssdm_thread_1 = load i1* @iosc_ssdm_thread_M_timeThread, align 1, !dbg !1212
  br i1 %iosc_ssdm_thread_1, label %3, label %4, !dbg !1212

; <label>:3                                       ; preds = %2
  call void @"iosc::timeThread"(i1* %clk, i1* %reset, i4* %ctrl, i4* %inSwitch, i4* %outLeds, i1* %timer, i4* %iosc_switchs_V), !dbg !1213
  br label %UnifiedUnreachableBlock

; <label>:4                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecProcessDecl([5 x i8]* @p_str, i32 2, [11 x i8]* @p_str16) nounwind, !dbg !1214
  call void (...)* @_ssdm_op_SpecSensitive([11 x i8]* @p_str16, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !1215
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !1216
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !1217
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %ctrl) nounwind, !dbg !1218
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %inSwitch) nounwind, !dbg !1219
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %outLeds) nounwind, !dbg !1220
  call void (...)* @_ssdm_op_SpecChannel([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str12, i32 1, i32 0, i1* %timer) nounwind, !dbg !1221
  ret void, !dbg !1222
...
_ZN7_ap_sc_7sc_core4waitEi.exit:
  %count = alloca i8
  call void @llvm.dbg.declare(metadata !{i8* %count}, metadata !1223)
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %clk), !map !1058
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %reset), !map !1062
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %ctrl), !map !1066
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %inSwitch), !map !1070
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %timer), !map !1078
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_switchs_V), !map !1082
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !1225), !dbg !1228
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !1229), !dbg !1228
  call void @llvm.dbg.value(metadata !{i4* %ctrl}, i64 0, metadata !1230), !dbg !1228
  call void @llvm.dbg.value(metadata !{i4* %inSwitch}, i64 0, metadata !1231), !dbg !1228
  call void @llvm.dbg.value(metadata !{i4* %outLeds}, i64 0, metadata !1232), !dbg !1228
  call void @llvm.dbg.value(metadata !{i1* %timer}, i64 0, metadata !1233), !dbg !1228
  call void @llvm.dbg.value(metadata !{i4* %iosc_switchs_V}, i64 0, metadata !1234), !dbg !1228
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !1235
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !1237
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %ctrl) nounwind, !dbg !1238
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %inSwitch) nounwind, !dbg !1239
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %outLeds) nounwind, !dbg !1240
  call void (...)* @_ssdm_op_SpecProcessDef([5 x i8]* @p_str, i32 2, [10 x i8]* @p_str8) nounwind, !dbg !1241
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !1242
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !1243
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !1244
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !1245), !dbg !1244
  call void (...)* @_ssdm_op_SpecIFCore(i4* %ctrl, [1 x i8]* @p_str10, [10 x i8]* @p_str14, [1 x i8]* @p_str10, i32 -1, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [17 x i8]* @p_str15), !dbg !1246
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !1247
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp_3), !dbg !1248
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1249
  store i8 0, i8* %count
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2, !dbg !1251

_ZN7_ap_sc_7sc_core4waitEi.exit2:                 ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, %_ZN7_ap_sc_7sc_core4waitEi.exit
  %count_load = load i8* %count, !dbg !1252
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1254
  %val_V = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %inSwitch), !dbg !1256
  call void @llvm.dbg.value(metadata !{i4 %val_V}, i64 0, metadata !1273), !dbg !1256
  %tmp = icmp eq i4 %val_V, -8, !dbg !1275
  %v_assign = select i1 %tmp, i8 0, i8 %count_load, !dbg !1252
  %val_V_1 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %ctrl), !dbg !1826
  call void @llvm.dbg.value(metadata !{i4 %val_V_1}, i64 0, metadata !1273), !dbg !1826
  %tmp_2 = icmp eq i4 %val_V_1, 0, !dbg !1831
  br i1 %tmp_2, label %0, label %3, !dbg !1830

; <label>:0                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  call void @llvm.dbg.value(metadata !{i1* %timer}, i64 0, metadata !1833), !dbg !1839
  %tmp_1 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %timer), !dbg !1845
  call void @llvm.dbg.value(metadata !{i1 %tmp_1}, i64 0, metadata !1847), !dbg !1840
  %v_V_2 = trunc i8 %v_assign to i4
  br i1 %tmp_1, label %1, label %2, !dbg !1843

; <label>:1                                       ; preds = %0
  %count_2 = add i8 %v_assign, 1, !dbg !1848
  call void @llvm.dbg.value(metadata !{i8 %count_2}, i64 0, metadata !1850), !dbg !1848
  call void @llvm.dbg.value(metadata !{i8 %count_2}, i64 0, metadata !1851), !dbg !1853
  call void @llvm.dbg.value(metadata !{i8 %count_2}, i64 0, metadata !1854), !dbg !1856
  call void @llvm.dbg.value(metadata !{i8 %count_2}, i64 0, metadata !1223), !dbg !1858
  %v_V_1 = add i4 %v_V_2, 1, !dbg !1860
  call void @llvm.dbg.value(metadata !{i4 %v_V_1}, i64 0, metadata !1862), !dbg !1870
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %outLeds, i4 %v_V_1), !dbg !1874
  store i8 %count_2, i8* %count, !dbg !1858
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, !dbg !1885

; <label>:2                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i8 %v_assign}, i64 0, metadata !1851), !dbg !1886
  call void @llvm.dbg.value(metadata !{i8 %v_assign}, i64 0, metadata !1854), !dbg !1889
  call void @llvm.dbg.value(metadata !{i8 %v_assign}, i64 0, metadata !1223), !dbg !1891
  call void @llvm.dbg.value(metadata !{i4 %v_V_2}, i64 0, metadata !1862), !dbg !1893
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %outLeds, i4 %v_V_2), !dbg !1895
  store i8 %v_assign, i8* %count, !dbg !1891
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge

; <label>:3                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  %val_V_4 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %inSwitch), !dbg !1898
  call void @llvm.dbg.value(metadata !{i4 %val_V_4}, i64 0, metadata !1273), !dbg !1898
  %val_V_5 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %ctrl), !dbg !1904
  call void @llvm.dbg.value(metadata !{i4 %val_V_5}, i64 0, metadata !1273), !dbg !1904
  call void @llvm.dbg.value(metadata !{i4 %val_V_4}, i64 0, metadata !1909), !dbg !1918
  call void @llvm.dbg.value(metadata !{i4 %val_V_5}, i64 0, metadata !1919), !dbg !1918
  %r_V = and i4 %val_V_5, %val_V_4, !dbg !1918
  call void @llvm.dbg.value(metadata !{i4 %r_V}, i64 0, metadata !1921), !dbg !1918
  call void @_ssdm_op_Write.ap_auto.i4P(i4* %iosc_switchs_V, i4 %r_V), !dbg !1924
  call void @llvm.dbg.value(metadata !{i4 %r_V}, i64 0, metadata !1862), !dbg !1927
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %outLeds, i4 %r_V), !dbg !1930
  store i8 %v_assign, i8* %count, !dbg !1891
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge

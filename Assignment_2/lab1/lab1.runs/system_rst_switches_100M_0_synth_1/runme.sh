...
HD_PWD='C:/ERTS_Repo/Assignment_2/lab1/lab1.runs/system_rst_switches_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_switches_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_switches_100M_0.tcl

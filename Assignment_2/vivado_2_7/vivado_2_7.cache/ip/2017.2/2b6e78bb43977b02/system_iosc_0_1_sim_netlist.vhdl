...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_iosc_0_1_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iosc_iosThread is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iosc_iosThread;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iosc_iosThread is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iosc_timeThread is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iosc_timeThread;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iosc_timeThread is
  signal ap_CS_fsm_state2 : STD_LOGIC;
...
begin
  SR(0) <= \^sr\(0);
  timer <= \^timer\;
grp_iosc_iosThread_fu_92: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iosc_iosThread
     port map (
...
grp_iosc_timeThread_fu_74: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iosc_timeThread
     port map (
      SR(0) => \^sr\(0),
      aclk => aclk,
      timer => \^timer\,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "system_iosc_0_1,iosc_top,{}";

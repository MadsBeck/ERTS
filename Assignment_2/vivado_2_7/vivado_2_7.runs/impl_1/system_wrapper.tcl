...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/ERTS_Repo/Assignment_2/vivado_2_7/vivado_2_7.cache/wt [current_project]
  set_property parent.project_path C:/ERTS_Repo/Assignment_2/vivado_2_7/vivado_2_7.xpr [current_project]
  set_property ip_repo_paths C:/ERTS_Repo/Assignment_2/SC_IO_test/SC_IO/solution1/impl/ip [current_project]
  set_property ip_output_repo C:/ERTS_Repo/Assignment_2/vivado_2_7/vivado_2_7.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet C:/ERTS_Repo/Assignment_2/vivado_2_7/vivado_2_7.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/ERTS_Repo/Assignment_2/vivado_2_7/vivado_2_7.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files C:/ERTS_Repo/Assignment_2/vivado_2_7/vivado_2_7.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc C:/ERTS_Repo/Assignment_2/vivado_2_7/vivado_2_7.srcs/constrs_1/imports/Assignment_2/contraints.xdc
  set_param project.isImplRun true

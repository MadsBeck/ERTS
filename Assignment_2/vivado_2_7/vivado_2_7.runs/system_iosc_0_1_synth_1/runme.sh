...
HD_PWD='C:/ERTS_Repo/Assignment_2/vivado_2_7/vivado_2_7.runs/system_iosc_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_iosc_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_iosc_0_1.tcl

...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/ERTS_repo/Project/Xilinx/ML_MNIST/ML_MNIST.cache/wt [current_project]
  set_property parent.project_path C:/ERTS_repo/Project/Xilinx/ML_MNIST/ML_MNIST.xpr [current_project]
  set_property ip_repo_paths {
  C:/ERTS_repo/Project/Xilinx_hls/neural/neural.prj/solution1/impl/ip
  C:/ERTS_repo/Assignment_2/led_ip_1.0
} [current_project]
  set_property ip_output_repo C:/ERTS_repo/Project/Xilinx/ML_MNIST/ML_MNIST.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet C:/ERTS_repo/Project/Xilinx/ML_MNIST/ML_MNIST.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/ERTS_repo/Project/Xilinx/ML_MNIST/ML_MNIST.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files C:/ERTS_repo/Project/Xilinx/ML_MNIST/ML_MNIST.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc C:/ERTS_repo/Project/Xilinx/ML_MNIST/ML_MNIST.srcs/constrs_1/imports/Xilinx/zybo.xdc
  read_xdc C:/ERTS_repo/Project/Xilinx/ML_MNIST/ML_MNIST.srcs/constrs_1/imports/lab3/lab3_zybo.xdc
  set_param project.isImplRun true

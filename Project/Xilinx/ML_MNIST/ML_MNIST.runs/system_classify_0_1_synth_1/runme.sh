...
HD_PWD='C:/ERTS_repo/Project/Xilinx/ML_MNIST/ML_MNIST.runs/system_classify_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_classify_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_classify_0_1.tcl

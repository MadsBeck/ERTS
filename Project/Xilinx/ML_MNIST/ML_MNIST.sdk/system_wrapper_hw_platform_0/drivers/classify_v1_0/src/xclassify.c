...
void XClassify_Set_out_r(XClassify *InstancePtr, u32 Data) {
    ...
    XClassify_WriteReg(InstancePtr->Nnio_BaseAddress, XCLASSIFY_NNIO_ADDR_OUT_R_DATA, Data);
}
...
u32 XClassify_Get_out_r(XClassify *InstancePtr) {
    ...
    Data = XClassify_ReadReg(InstancePtr->Nnio_BaseAddress, XCLASSIFY_NNIO_ADDR_OUT_R_DATA);
    return Data;
}

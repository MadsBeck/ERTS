...
if {[file isfile classify.autotvin.dat]} {
	file delete -force classify.autotvin.dat
}

if {[file isfile classify.autotvout.dat]} {
	file delete -force classify.autotvout.dat
}

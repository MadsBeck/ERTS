...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "classify.autotvin.dat"
	set constFileTvOut       "classify.autotvout.dat"
	set constFileHdlTvIn     "classify.autohdltvin.dat"
	set constFileHdlTvOut    "classify.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

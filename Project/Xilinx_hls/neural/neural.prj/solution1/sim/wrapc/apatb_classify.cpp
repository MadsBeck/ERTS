...
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.classify.autotvout_ap_return.dat"
...
unsigned char AESL_WRAP_classify (
signed char img[16])
{
	...
	else
	{
		...
		sc_bv<8>* img_tvin_wrapc_buffer = new sc_bv<8>[16];
		...
		tcl_file.set_num(16, &tcl_file.img_depth);
...
// [call_c_dut] ---------->
		...
		unsigned char AESL_return = classify(img);

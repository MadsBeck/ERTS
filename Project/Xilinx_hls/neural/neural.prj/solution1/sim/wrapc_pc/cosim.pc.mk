...
$(ObjDir)/classifier_tb.cpp_pre.cpp.tb.o : classifier_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling classifier_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/NN.cpp_pre.cpp.tb.o : NN.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling NN.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/classifier.cpp_pre.cpp.tb.o : classifier.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling classifier.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
